...
function Mensaje(t){
        switch (t) {
            ...
            case 2: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-danger' role='alert'>Se elimino</div>"
                );
                break;
            default:
...
if (dbVacas.length !== 0) {
    ...
    $("#dbVacas-list").append("<h2> No tienes producto </h2>");
}
...
function contarVacas(){
    ...
    $("#numeroVacas").append(
        "<a>Tienes actualmente" + "<br>" + "<span class='badge'>" + nVacas + "</span></a> producto"
    );
    return nVacas;
}
